...
$.ajax({
  ...
  data: {
    key: '5J3BZ-MMKC5-NBWI5-ITWFT-7GP4F-XTF34',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(111.53, 27.51, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime1() {
  var grt = new Date("10/10/2023 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Sheep🐏 %c 你正在访问Sheep🐏の小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| Sheep🐏") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('Sheep🐏的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  var start = new Date("10/10/2023 00:00:00"); // 旅行者1号开始计算的时间
  var dis = Math.trunc(23400000000 + ((now - start) / 1000) * 17); // 距离=秒数*速度 记住转换毫秒
  var unit = (dis / 149600000).toFixed(6);  // 天文单位
  // 网站诞生时间
  var grt = new Date("10/10/2023 00:00:00");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://pic2.zhimg.com/v2-deeff92945c06c45c150603e9e63c175_b.webp' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://pic2.zhimg.com/v2-deeff92945c06c45c150603e9e63c175_b.webp' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://img2.imgtp.com/2024/03/04/QwAzgVwP.webp);
    --darkmode-bg:url(https://img2.imgtp.com/2024/03/04/QwAzgVwP.webp);
    --mobileday-bg: url(https://img2.imgtp.com/2024/03/04/aDjQ7hfM.webp);
    --mobilenight-bg: url(https://img2.imgtp.com/2024/03/04/aDjQ7hfM.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://img2.imgtp.com/2024/03/04/AIsz9gmv.webp)" class="imgbox" onclick="changeBg('url(https://img2.imgtp.com/2024/03/04/AIsz9gmv.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://img2.imgtp.com/2024/03/04/Iwz0x0TU.webp)" class="imgbox" onclick="changeBg('url(https://img2.imgtp.com/2024/03/04/Iwz0x0TU.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://img2.imgtp.com/2024/03/04/V3uCLOUV.webp)" class="imgbox" onclick="changeBg('url(https://img2.imgtp.com/2024/03/04/V3uCLOUV.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://img2.imgtp.com/2024/03/04/pi3y1ZEg.webp)" class="pimgbox" onclick="changeBg('url(https://img2.imgtp.com/2024/03/04/pi3y1ZEg.webp)')"></a></div>
              </div>
            </details>
